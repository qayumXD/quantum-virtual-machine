...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../screenshots/web_gui_main.png}
\caption{Web GUI Main Interface}
\label{fig:web_gui_main}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{../screenshots/cli_execution.png}
\caption{CLI Execution Example}
