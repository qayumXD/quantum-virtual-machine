...
\begin{figure}[ht]
\centering
\includegraphics[width=0.75\textwidth]{../uml/QVM_Architecture_Diagram.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{../uml/Activity_Circuit_Execution.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.5\textwidth]{../uml/Activity_Transpilation.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{../uml/Activity_Simulation.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{../uml/QVM_Class_Diagram.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{../uml/Sequence_CLI_Execution.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{../uml/Sequence_API_Request.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\textwidth]{../uml/Sequence_Transpilation_Detail.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.8\textwidth]{../uml/State_Circuit_Lifecycle.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{../uml/DFD_Level1.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.9\textwidth]{../uml/DFD_Level2.png}
