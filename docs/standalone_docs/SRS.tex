...
\begin{titlepage}
    ...
    % Degree Statement
    {\large A Software Requirements Specification (SRS) Submitted in Partial Fulfillment of the Requirements \par}
...
% Only include Chapter 3: Requirement Analysis

% Chapter 3: Requirement Analysis (core SRS content)
\input{../fyp_latex/ch_3_requirements}
