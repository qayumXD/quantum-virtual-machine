...
The intermediate representation acts as the decoupled bridge between frontend parser structures and backend simulators. The core representation class is `QuantumCircuit`, defined in [ir.py](file:///home/qayum/projects/quantum-virtual-machine/src/qvm/ir.py).
...
To support Variational Quantum Algorithms (like VQE and QAOA), QVM provides symbolic parameter structures defined in [parameter.py](file:///home/qayum/projects/quantum-virtual-machine/src/qvm/parameter.py):
...
Defined in [src/qvm/util/export.py](file:///home/qayum/projects/quantum-virtual-machine/src/qvm/util/export.py). It maps operations into OpenQASM 2.0 standard syntax:
