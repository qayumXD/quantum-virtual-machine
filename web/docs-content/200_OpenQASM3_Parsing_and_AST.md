...
The parser utilizes the **Lark LALR(1)** parser engine. The grammar rules defined in [qasm3.lark](file:///home/qayum/projects/quantum-virtual-machine/src/qvm/qasm3.lark) target a specific subset of OpenQASM 3.0:
...
The parsing process in [qasm3_parser.py](file:///home/qayum/projects/quantum-virtual-machine/src/qvm/qasm3_parser.py) executes in two sequential passes over the syntax tree:
