...
Physical quantum computers suffer from decoherence and gate errors. The QVM provides a noise simulation system in [noise.py](file:///home/qayum/projects/quantum-virtual-machine/src/qvm/noise.py), modeling physical noise channels using Kraus operators and stochastic trajectories.
