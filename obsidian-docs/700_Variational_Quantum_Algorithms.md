...
Variational Quantum Algorithms (VQAs) are hybrid quantum-classical algorithms. They use a classical optimizer to update the parameters of a quantum circuit (ansatz) to minimize a cost function. QVM implements these algorithms in [vqe.py](https://github.com/qayumXD/quantum-virtual-machine/blob/main/src/qvm/vqe.py), [qaoa.py](https://github.com/qayumXD/quantum-virtual-machine/blob/main/src/qvm/qaoa.py), [observable.py](https://github.com/qayumXD/quantum-virtual-machine/blob/main/src/qvm/observable.py), and [gradient.py](https://github.com/qayumXD/quantum-virtual-machine/blob/main/src/qvm/gradient.py).
