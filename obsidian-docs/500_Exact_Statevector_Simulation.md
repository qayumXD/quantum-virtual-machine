...
The Statevector Simulator, implemented in [simulator.py](https://github.com/qayumXD/quantum-virtual-machine/blob/main/src/qvm/simulator.py), is the exact execution engine of the QVM. It represents the quantum state as a complex vector and applies unitary matrices to evolve the state.
